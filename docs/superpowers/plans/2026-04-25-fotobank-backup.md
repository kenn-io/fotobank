...
Run: `sed -n '90,135p' /path/to/fotobank/internal/cli/server.go`
...
```bash
grep -n "AddCommand" /path/to/fotobank/internal/cli/root.go
```
...
Run: `grep -n "loadConfigFromCmd\|loadConfig\|config.Load" /path/to/fotobank/internal/cli/*.go`
