...
mkdir -p /Users/wesm/code/fotobank/testdata/thumb
mv /tmp/portrait-plain.jpg /Users/wesm/code/fotobank/testdata/thumb/portrait-orient6.jpg
```
...
```bash
grep -rn "TestE2EMediaPipeline" /Users/wesm/code/fotobank/internal/ | head -3
```
