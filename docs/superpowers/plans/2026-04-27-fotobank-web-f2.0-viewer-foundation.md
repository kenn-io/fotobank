...
```bash
cd /Users/wesm/code/fotobank && go test ./... -short -shuffle=on
cd /Users/wesm/code/fotobank/frontend && bun run typecheck && bun run test
```
...
```bash
cd /Users/wesm/code/fotobank/frontend && bun run test -- src/lib/router/router.test.ts
```
...
```bash
cd /Users/wesm/code/fotobank/frontend && bun run test -- src/lib/media/mediaStore.test.ts
```
...
```bash
cd /Users/wesm/code/fotobank && go test ./internal/thumb -run "TestSizeMaxEdge|TestParseSizeValid|TestParseSizeLightboxIsRemoved|TestAllSizes" -v
```
...
```bash
cd /Users/wesm/code/fotobank && go test ./internal/thumb/... -v
```
...
```bash
cd /Users/wesm/code/fotobank && go test ./internal/thumb -run "TestWorker" -v
```
...
```bash
cd /Users/wesm/code/fotobank && rg -n "TestThumbRouteUnknownSizeReturns400|size=preview|size=lightbox" internal/httpapi/media_thumb_test.go
```
...
```bash
cd /Users/wesm/code/fotobank && rg -n "lightbox|2048" internal/httpapi/media_thumb_test.go
```
...
```bash
cd /Users/wesm/code/fotobank && go test ./... -shuffle=on
cd /Users/wesm/code/fotobank/frontend && bun run typecheck && bun run test
cd /Users/wesm/code/fotobank && make test-e2e
```
...
```bash
cd /Users/wesm/code/fotobank && rg -n "lightbox|SizeLightbox" -- internal/ frontend/src/ frontend/tests/
```
...
```bash
cd /Users/wesm/code/fotobank && make lint && make nilaway
```
