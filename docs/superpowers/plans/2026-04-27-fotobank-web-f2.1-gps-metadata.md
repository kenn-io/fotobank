...
cd /Users/wesm/code/fotobank/frontend && bunx playwright test
```
...
```bash
mkdir -p /Users/wesm/code/fotobank/internal/geo/data
```
...
```bash
cd /Users/wesm/code/fotobank/internal/geo/data
...
Open `/Users/wesm/code/fotobank/prek.toml`. Update the `check-added-large-files` hook entry inside the builtin repos block:
...
```bash
sed -n '1,60p' /Users/wesm/code/fotobank/frontend/src/lib/media/mediaStore.svelte.ts
sed -n '60,170p' /Users/wesm/code/fotobank/frontend/src/lib/media/mediaStore.svelte.ts
```
...
```bash
cat /Users/wesm/code/fotobank/frontend/src/routes/MediaDetail.svelte
```
