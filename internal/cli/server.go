...
import (
	...
	aiworker "go.kenn.io/fotobank/internal/ai/worker"
...
func runPhotoServer(ctx context.Context, opts serverOpts, removeRuntime *func()) (retErr error) {
	...
	op, err := operator.Start(sigCtx, opts.cfgPath, version.Short, cfg.Daemon.ListenAddress, webURL, false, stop, operatorDeps)
	if err != nil {
