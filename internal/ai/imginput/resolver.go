...
// ResolveAndEncode reads the media row, loads the versioned preview
// blob, and re-encodes it to the AI input profile. When thumb_status is
// not "ready", returns the status verbatim so the worker can pick the
