...
var (
	...
	ErrBackupRepositoryLocked            = errors.New("backup repository is locked")
	ErrBackupRestoreTargetActive         = errors.New("backup restore target is active")
	ErrBackupRestoreTargetChanged        = errors.New("backup restore target changed")
	ErrBackupRestoreTargetNotEmpty       = errors.New("backup restore target is not empty")
	ErrBackupRestoreTargetOverlap        = errors.New("backup restore target overlaps protected storage")
	ErrBackupRestoreConfigurationChanged = errors.New("storage configuration changed")
